...
public class MetadataServiceController {
    ...
    public ResponseEntity<MetadataServiceResponse> getMovieById(@PathVariable("movieId") String movieId) throws MetadataServiceException {
    ...
    public ResponseEntity<MetadataServiceResponse> getMovieByTitle(@PathVariable("movieTitle") String movieTitle) throws MetadataServiceException {
        final MetadataServiceResponse metadataServiceResponse = metadataService.getMovieByTitle(movieTitle);
        return ResponseEntity.ok(metadataServiceResponse);
    }
