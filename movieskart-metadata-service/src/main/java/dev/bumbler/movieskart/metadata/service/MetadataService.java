...
public class MetadataService {
  ...
  public MetadataServiceResponse getMovieByTitle(String movieTitle)
  ...
  private MetadataServiceResponse prepareMetadataServiceResponse(List<Movie> movies) {
    return new MetadataServiceResponse(
        movies, HttpStatus.OK, Constants.METADATA_SERVICE_SUCCESS_RESPONSE_MESSAGE);
  }
